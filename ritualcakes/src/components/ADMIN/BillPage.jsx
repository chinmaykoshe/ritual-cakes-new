                ...
                <div className="flex justify-between items-center mb-6">
                    ...
                    <div className="text-right">
                        ...
                        <p className="text-gray-600 text-sm">
                            Date: {editMode ? <input type="date" value={order.orderDate ? order.orderDate.slice(0, 10) : ""} onChange={e => handleChange("orderDate", e.target.value)} className="border px-1 py-1 w-full" /> : new Date(order.orderDate).toLocaleDateString()}
                        </p>
                        <p className="text-gray-600 text-sm">
