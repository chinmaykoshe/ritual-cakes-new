...
const ReviewSection = () => {
  ...
  const fetchReviews = async () => {
    try {
      const response = await fetch("https://ritual-cakes--alpha.vercel.app/api/reviews");
  ...
  const handleSaveEdit = async (reviewID) => {
    try {
      const token = localStorage.getItem('token');
      const response = await fetch(`https://ritual-cakes--alpha.vercel.app/api/reviews/${reviewID}`, {
        method: "PUT",
        headers: {
